...
//    private final Map<String, Dialogue> dialogues = new LinkedHashMap<>(); // Ordered dialogues
...
//    }
//
//    public List<String> getDialogueOrder() {
//        return new ArrayList<>(dialogueOrder);
//    }
//
...
//            player.sendMessage(ChatColor.GRAY + npc.getName() + ": " + ChatColor.WHITE + message);
//            return;
//        }
//
...
//            player.sendMessage(ChatColor.GRAY + npc.getName() + ": " + ChatColor.WHITE + dialogue.getInsufficientLevelMessage());
//            return;
//        }
//
...
//        PlayerData data = playerDataCache.getCachedPlayerData(player.getUniqueId());
//        Set<String> completedDialogues = data.getCompletedDialogues();
//
//        for (String dialogueId : dialogueOrder) {
