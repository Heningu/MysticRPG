...
//            player.sendMessage(ChatColor.GRAY + completionMessage);
//            return;
//        }
//
...
//            player.sendMessage(ChatColor.GRAY + "Have you completed the quest?");
//            return;
//        }
//
...
//        TextComponent questionComponent = new TextComponent(ChatColor.GRAY + question + " ");
...
//            player.sendMessage(ChatColor.GRAY + yesResponse);
//            if (questId != null) {
...
//                        player.sendMessage(ChatColor.AQUA + "You have received a new quest: " + quest.getName());
//                    } else {
//                        player.sendMessage(ChatColor.YELLOW + "You have already received this quest.");
//                    }
//                }
//            }
//            // Do not mark dialogue as completed yet, wait until quest is completed
//        } else {
//            player.sendMessage(ChatColor.GRAY + noResponse);
