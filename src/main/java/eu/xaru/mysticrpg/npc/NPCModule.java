...
//                            player.sendMessage(Utils.getInstance().$("NPC '" + name + "' spawned.");
//                        }))
...
//                            if (success) {
//                                player.sendMessage(Utils.getInstance().$("NPC '" + name + "' deleted.");
//                            } else {
//                                player.sendMessage(Utils.getInstance().$("NPC '" + name + "' not found.");
//                            }
//                        }))
...
//                            if (success) {
//                                player.sendMessage(Utils.getInstance().$("NPC '" + name + "' behavior set to '" + behavior + "'.");
//                            } else {
//                                player.sendMessage(Utils.getInstance().$("NPC '" + name + "' not found or behavior invalid.");
//                            }
//                        }))
...
//                            if (success) {
//                                player.sendMessage(Utils.getInstance().$("NPC '" + name + "' skin changed.");
//                            } else {
//                                player.sendMessage(Utils.getInstance().$("NPC '" + name + "' not found.");
//                            }
//                        }))
...
//                        }
//                    } else {
//                        player.sendMessage(Utils.getInstance().$("NPC not found.");
//                    }
//                })
//                .register();
//    }
