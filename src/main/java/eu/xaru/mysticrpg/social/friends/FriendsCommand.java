...
//    private final FriendsHelper friendsManager;
//    private final FriendsInventory friendsMenu;
//
//    public FriendsCommand(MysticCore plugin, FriendsHelper friendsManager, FriendsInventory friendsMenu) {
//        this.plugin = plugin;
