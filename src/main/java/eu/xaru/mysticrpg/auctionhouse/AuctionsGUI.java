...
// import eu.xaru.mysticrpg.guis.auctionhouse.BuyGUI;
// import eu.xaru.mysticrpg.guis.auctionhouse.SellGUI;
// import eu.xaru.mysticrpg.guis.auctionhouse.YourAuctionsGUI;
...
//         this.buyGUI = new BuyGUI();
//         this.sellGUI = new SellGUI(this);
//         this.yourAuctionsGUI = new YourAuctionsGUI();
//     }
...
//                 // Reopen Buy GUI
//                 Bukkit.getScheduler().runTask(plugin, () -> buyGUI.openAuctionHouseBuyGUI(player));
