...
public abstract class AbstractMergedWindow extends AbstractDoubleWindow {
    ...
    @Override
    protected List<eu.xaru.mysticrpg.guis.invui.inventory.Inventory> getContentInventories() {
        List<eu.xaru.mysticrpg.guis.invui.inventory.Inventory> inventories = new ArrayList<>(gui.getAllInventories());
