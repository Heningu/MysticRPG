package eu.xaru.mysticrpg.guis.invui.window;
...
import eu.xaru.mysticrpg.guis.invui.invaccess.InventoryAccess;
import eu.xaru.mysticrpg.guis.invui.invaccess.component.BungeeComponentWrapper;
import eu.xaru.mysticrpg.guis.invui.invaccess.component.ComponentWrapper;
import eu.xaru.mysticrpg.guis.invui.invaccess.component.i18n.Languages;
import eu.xaru.mysticrpg.guis.invui.InvUI;
import eu.xaru.mysticrpg.guis.invui.gui.AbstractGui;
import eu.xaru.mysticrpg.guis.invui.gui.Gui;
import eu.xaru.mysticrpg.guis.invui.gui.GuiParent;
import eu.xaru.mysticrpg.guis.invui.gui.SlotElement;
import eu.xaru.mysticrpg.guis.invui.inventory.CompositeInventory;
import eu.xaru.mysticrpg.guis.invui.inventory.Inventory;
import eu.xaru.mysticrpg.guis.invui.inventory.VirtualInventory;
import eu.xaru.mysticrpg.guis.invui.inventory.event.PlayerUpdateReason;
import eu.xaru.mysticrpg.guis.invui.inventory.event.UpdateReason;
import eu.xaru.mysticrpg.guis.invui.item.Item;
import eu.xaru.mysticrpg.guis.invui.item.ItemProvider;
import eu.xaru.mysticrpg.guis.invui.util.ArrayUtils;
import eu.xaru.mysticrpg.guis.invui.util.Pair;
...
public abstract class AbstractWindow implements Window, GuiParent {
    ...
    /**
     * Gets the content {@link eu.xaru.mysticrpg.guis.invui.inventory.Inventory inventories} associated with this
     ...
     */
    protected abstract List<eu.xaru.mysticrpg.guis.invui.inventory.Inventory> getContentInventories();
