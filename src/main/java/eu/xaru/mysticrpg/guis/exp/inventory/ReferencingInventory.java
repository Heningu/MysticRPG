...
import eu.xaru.mysticrpg.guis.exp.util.TriConsumer;
import eu.xaru.mysticrpg.guis.exp.window.Window;
...
/**
 * A {@link eu.xaru.mysticrpg.guis.exp.inventory.Inventory} which is backed by a bukkit {@link Inventory}.
 * <p>
 * Changes in this inventory are applied in the referenced inventory and changes in the bukkit inventory are visible
 * in this inventory.
 * <p>
 * Changes done using the methods provided by {@link eu.xaru.mysticrpg.guis.exp.inventory.Inventory} will cause displaying
 * {@link Window Windows} to be {@link eu.xaru.mysticrpg.guis.exp.inventory.Inventory#notifyWindows() notified}, but changes
 * done directly in the bukkit inventory will not. Therefore, if embedded in a {@link Gui}, it is necessary to call
 * {@link eu.xaru.mysticrpg.guis.exp.inventory.Inventory#notifyWindows()} manually in order for changes to be displayed.
 */
public class ReferencingInventory extends eu.xaru.mysticrpg.guis.exp.inventory.Inventory {
