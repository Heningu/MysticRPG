...
import eu.xaru.mysticrpg.guis.exp.invaccess.map.MapIcon;
import eu.xaru.mysticrpg.guis.exp.invaccess.map.MapPatch;
import eu.xaru.mysticrpg.guis.exp.gui.AbstractGui;
import eu.xaru.mysticrpg.guis.exp.gui.Gui;
import eu.xaru.mysticrpg.guis.exp.item.impl.SimpleItem;
import eu.xaru.mysticrpg.guis.exp.util.MathUtils;
