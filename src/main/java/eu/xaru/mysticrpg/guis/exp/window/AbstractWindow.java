...
import eu.xaru.mysticrpg.guis.exp.invaccess.InventoryAccess;
import eu.xaru.mysticrpg.guis.exp.invaccess.component.BungeeComponentWrapper;
import eu.xaru.mysticrpg.guis.exp.invaccess.component.ComponentWrapper;
import eu.xaru.mysticrpg.guis.exp.invaccess.component.i18n.Languages;
import eu.xaru.mysticrpg.guis.exp.InvUI;
import eu.xaru.mysticrpg.guis.exp.gui.AbstractGui;
import eu.xaru.mysticrpg.guis.exp.gui.Gui;
import eu.xaru.mysticrpg.guis.exp.gui.GuiParent;
import eu.xaru.mysticrpg.guis.exp.gui.SlotElement;
import eu.xaru.mysticrpg.guis.exp.inventory.CompositeInventory;
import eu.xaru.mysticrpg.guis.exp.inventory.Inventory;
import eu.xaru.mysticrpg.guis.exp.inventory.VirtualInventory;
import eu.xaru.mysticrpg.guis.exp.inventory.event.PlayerUpdateReason;
import eu.xaru.mysticrpg.guis.exp.inventory.event.UpdateReason;
import eu.xaru.mysticrpg.guis.exp.item.Item;
import eu.xaru.mysticrpg.guis.exp.item.ItemProvider;
import eu.xaru.mysticrpg.guis.exp.util.ArrayUtils;
...
public abstract class AbstractWindow implements Window, GuiParent {
    ...
    /**
     * Gets the content {@link eu.xaru.mysticrpg.guis.exp.inventory.Inventory inventories} associated with this
     ...
     */
    protected abstract List<eu.xaru.mysticrpg.guis.exp.inventory.Inventory> getContentInventories();
