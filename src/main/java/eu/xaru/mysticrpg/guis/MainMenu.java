...
import eu.xaru.mysticrpg.guis.economy.BankGUI;
...
public class MainMenu {
    ...
    public Gui buildGui() {
        ...
        Item bank = new SimpleItem(new ItemBuilder(Material.GOLD_INGOT)
                .setDisplayName("Bank")
                .addLoreLines(
                        "Access bank without NPC while Alpha!"
                )
                .addEnchantment(Enchantment.UNBREAKING, 1, true)
                .addAllItemFlags()) {
            @Override
