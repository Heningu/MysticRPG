...
public class DungeonConfig {
    ...
    private int levelRequirement = 1; // default
    ...
    public String getDifficulty() {
        return (difficulty == null || difficulty.isEmpty()) ? "Normal" : difficulty;
    }
    ...
    public void setMobSpawnPoints(List<MobSpawnPoint> mobSpawnPoints) { this.mobSpawnPoints = mobSpawnPoints; }
    ...
    public Location getPortalPos1() { return portalPos1; }
    public void setPortalPos1(Location portalPos1) { this.portalPos1 = portalPos1; }

    public int getLevelRequirement() { return levelRequirement; }
    public void setLevelRequirement(int levelRequirement) { this.levelRequirement = levelRequirement; }

    public List<DoorData> getDoors() { return doors; }
